 ...
 * @author aritrasmac
 */
public class admin_add_airport extends javax.swing.JFrame {
public String admin;//decare public variable admin
    /**
     * Creates new form admin_add_airport
     */
    public admin_add_airport() {
        initComponents();
    }
    
    public admin_add_airport(String val1) {//create constructor of the page
        initComponents();
        
        this.admin = val1;//assign variable to the passed value
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 210, 160, -1));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 130, 60));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 210, 280, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 360, 190, 50));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 360, 190, 50));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new admin_action(admin).setVisible(true);//open admin action page
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_add_airport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_add_airport().setVisible(true);
            }
        });
    }
